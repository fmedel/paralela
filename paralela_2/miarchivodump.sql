...
--
-- Name: camino; Type: TABLE; Schema: public; Owner: felipe
--
...
ALTER TABLE camino OWNER TO felipe;

--
-- Name: camino_id_camino_seq; Type: SEQUENCE; Schema: public; Owner: felipe
--
...
ALTER TABLE camino_id_camino_seq OWNER TO felipe;

--
-- Name: camino_id_camino_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: felipe
--
...
--
-- Name: laberinto; Type: TABLE; Schema: public; Owner: felipe
--
...
ALTER TABLE laberinto OWNER TO felipe;

--
-- Name: laberinto_id_laberinto_seq; Type: SEQUENCE; Schema: public; Owner: felipe
--
...
ALTER TABLE laberinto_id_laberinto_seq OWNER TO felipe;

--
-- Name: laberinto_id_laberinto_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: felipe
--
...
--
-- Name: id_camino; Type: DEFAULT; Schema: public; Owner: felipe
--
...
--
-- Name: id_laberinto; Type: DEFAULT; Schema: public; Owner: felipe
--
...
--
-- Data for Name: camino; Type: TABLE DATA; Schema: public; Owner: felipe
--


--
-- Name: camino_pkey; Type: CONSTRAINT; Schema: public; Owner: felipe
--
...
--
-- Name: laberinto_pkey; Type: CONSTRAINT; Schema: public; Owner: felipe
--
